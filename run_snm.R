...
RUNNAME = 'snm'
SIMNAME = 'lonlatrcn' #change this to separate different simulations
...
for(irow in nrow(whichdates):1){#simulate in reverse will download less data
	...
	# new cdec url downloadURL=paste0('http://cdec.water.ca.gov/dynamicapp/req/CSVDataServlet?Stations=',site_id,'&SensorNums=82&dur_code=D&Start=1900-01-01&End=',strftime(simdate,'%Y-%m-%d'))
